...
contract Kerosene {
  ...
  string public constant name = "Kerosene";
  string public constant symbol = "KER";
  ...
  constructor(uint96 initialSupply) {
    _transferTokens(address(0), msg.sender, initialSupply);
  ...
  function transfer(address _to, uint96 _value) public returns (bool) {
    _transferTokens(msg.sender, _to, _value);
    return true;
  }

  function transferFrom(address _from, address _to, uint96 _value) public returns (bool) {
    allowance[_from][msg.sender] -= _value;
    _transferTokens(_from, _to, _value);
    return true;
  }

  function approve(address _spender, uint96 _value) public returns (bool) {
    allowance[msg.sender][_spender] = _value;
    emit Approval(msg.sender, _spender, _value);
    return true;
  }

  function mint(address _to, uint96 _value) public {
    require(msg.sender == minter, "Don't call this function!");
    _transferTokens(address(0), _to, _value);
    totalSupply += _value;
  }

  function burn(uint96 _value) public {
    _transferTokens(msg.sender, address(0), _value);
    totalSupply -= _value;
  }
